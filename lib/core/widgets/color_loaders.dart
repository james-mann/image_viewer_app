            ...
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  ...
                  child: Dot(
                    radius: radius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.card,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.teal,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.sapphire,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.red,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.yellow,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.green,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.flamingo,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<ImageViewerColors>()!.lavender,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
