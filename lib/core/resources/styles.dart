...
class ImageViewerColors extends ThemeExtension<ImageViewerColors> {
  ...
  @override
  ThemeExtension<ImageViewerColors> copyWith({
    Color? background,
    Color? card,
    Color? buttonText,
    Color? subtitle,
  ...
  @override
  ThemeExtension<ImageViewerColors> lerp(
    covariant ThemeExtension<ImageViewerColors>? other,
    double t,
  ) {
    if (other is! ImageViewerColors) {
      return this;
    }
    return ImageViewerColors(
...
class BoxDecorations {
  ...
  BoxDecoration get dialogAlt => BoxDecoration(
        color: Theme.of(context).extension<ImageViewerColors>()!.background,
        borderRadius:
            const BorderRadius.all(Radius.circular(Dimens.cornerRadius)),
        boxShadow: [BoxShadows(context).dialogAlt],
      );

  BoxDecoration get bottomSheet => BoxDecoration(
        color: Theme.of(context).extension<ImageViewerColors>()!.background,
        borderRadius: const BorderRadius.only(
          topLeft: Radius.circular(Dimens.cornerRadiusBottomSheet),
          topRight: Radius.circular(Dimens.cornerRadiusBottomSheet),
        ),
        boxShadow: [BoxShadows(context).dialog],
      );

  BoxDecoration get buttonMenu => BoxDecoration(
        color: Theme.of(context).extension<ImageViewerColors>()!.background,
        borderRadius: const BorderRadius.all(
          Radius.circular(Dimens.cornerRadius),
        ),
        boxShadow: [BoxShadows(context).buttonMenu],
      );
}
...
class BoxShadows {
  ...
  BoxShadow get dialog => BoxShadow(
        color: Theme.of(context).extension<ImageViewerColors>()!.shadow!,
