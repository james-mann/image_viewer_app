...
extension StringExtension on String {
  ...
  void toToastError(BuildContext context) {
    try {
      ...
      showToastWidget(
        Toast(
          bgColor: Theme.of(context).extension<ImageViewerColors>()!.red,
          icon: Icons.error,
          message: message,
  ...
  void toToastSuccess(BuildContext context) {
    try {
      ...
      showToastWidget(
        Toast(
          bgColor: Theme.of(context).extension<ImageViewerColors>()!.green,
  ...
  void toToastLoading(BuildContext context) {
    try {
      ...
      showToastWidget(
        Toast(
          bgColor: Theme.of(context).extension<ImageViewerColors>()!.pink,
          icon: Icons.info,
          message: message,
          textColor: Colors.white,
        ),
